...
public class ServerController {
                ...
                try {
                    ...
                    if (!validateIpAddress(enter_ip_address_label.getText())) {
                        ...
                        try {
                            ...
                            client_socket.connect(new InetSocketAddress(enter_ip_address_label.getText(), port_number_integer), 3000);

                            Main.setClient(new Client(client_socket, enter_username_field.getText()));

                            Thread client_thread = new Thread(Main.getClient());
    ...
    public void switchToServerWait() {
        ...
        try {
            ...
            Server server = new Server(server_socket, server_username_label.getText());
